        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-muted-foreground text-base">
              ...
              <div><span className="font-semibold text-foreground">Jt. Secretary:</span> Safiulla  Shaikh</div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Click the button below to cast your vote in our community poll. Your participation is important!
                </p>
                <motion.a
                  href="https://strawpoll.com/40Zm4N0jlga"
                  target="_blank"
